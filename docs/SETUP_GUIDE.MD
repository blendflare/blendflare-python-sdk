...
# This creates:
# - dist/blendflare-1.0.3-py3-none-any.whl
# - dist/blendflare-1.0.3.tar.gz
```
...
```bash
# Install the wheel
pip install dist/blendflare-1.0.3-py3-none-any.whl

# Or install the source distribution
pip install dist/blendflare-1.0.3.tar.gz
```
